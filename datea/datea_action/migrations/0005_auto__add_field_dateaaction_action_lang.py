...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DateaAction.action_lang'
        db.add_column('datea_action_dateaaction', 'action_lang',
                      self.gf('django.db.models.fields.CharField')(default='es', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DateaAction.action_lang'
        db.delete_column('datea_action_dateaaction', 'action_lang')
    ...
    models = {
        ...
        'datea_action.dateaaction': {
            ...
            'action_lang': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
