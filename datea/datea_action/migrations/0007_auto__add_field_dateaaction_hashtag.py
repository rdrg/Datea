...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DateaAction.hashtag'
        db.add_column('datea_action_dateaaction', 'hashtag',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DateaAction.hashtag'
        db.delete_column('datea_action_dateaaction', 'hashtag')
