...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DateaAction.item_count'
        db.add_column('datea_action_dateaaction', 'item_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'DateaAction.user_count'
        db.add_column('datea_action_dateaaction', 'user_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'DateaAction.comment_count'
        db.add_column('datea_action_dateaaction', 'comment_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'DateaAction.follower_count'
        db.add_column('datea_action_dateaaction', 'follower_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DateaAction.item_count'
        db.delete_column('datea_action_dateaaction', 'item_count')

        # Deleting field 'DateaAction.user_count'
        db.delete_column('datea_action_dateaaction', 'user_count')

        # Deleting field 'DateaAction.comment_count'
        db.delete_column('datea_action_dateaaction', 'comment_count')

        # Deleting field 'DateaAction.follower_count'
        db.delete_column('datea_action_dateaaction', 'follower_count')
