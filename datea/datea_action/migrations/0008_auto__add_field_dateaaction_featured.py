...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DateaAction.featured'
        db.add_column('datea_action_dateaaction', 'featured',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DateaAction.featured'
        db.delete_column('datea_action_dateaaction', 'featured')
