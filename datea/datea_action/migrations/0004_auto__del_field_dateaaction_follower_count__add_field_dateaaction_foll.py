...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DateaAction.follow_count'
        db.add_column('datea_action_dateaaction', 'follow_count',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'DateaAction.follow_count'
        db.delete_column('datea_action_dateaaction', 'follow_count')
