...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DateaAction.image'
        db.add_column('datea_action_dateaaction', 'image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='actions', null=True, to=orm['datea_image.DateaImage']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DateaAction.image'
        db.delete_column('datea_action_dateaaction', 'image_id')
