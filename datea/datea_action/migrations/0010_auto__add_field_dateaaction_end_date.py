...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DateaAction.end_date'
        db.add_column('datea_action_dateaaction', 'end_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DateaAction.end_date'
        db.delete_column('datea_action_dateaaction', 'end_date')
