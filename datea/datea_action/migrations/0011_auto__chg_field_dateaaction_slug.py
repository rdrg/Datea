...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DateaAction.slug'
        db.alter_column('datea_action_dateaaction', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=120))

    def backwards(self, orm):

        # Changing field 'DateaAction.slug'
        db.alter_column('datea_action_dateaaction', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=30))
