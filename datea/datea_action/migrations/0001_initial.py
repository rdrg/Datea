...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DateaAction'
        db.create_table('datea_action_dateaaction', (
            ...
            ('category', self.gf('mptt.fields.TreeForeignKey')(default=None, related_name='actions', null=True, blank=True, to=orm['datea_category.DateaCategory'])),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True)),
        ))
        db.send_create_signal('datea_action', ['DateaAction'])


    def backwards(self, orm):
        # Deleting model 'DateaAction'
        db.delete_table('datea_action_dateaaction')
