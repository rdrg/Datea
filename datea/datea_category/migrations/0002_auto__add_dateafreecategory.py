...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DateaFreeCategory'
        db.create_table('datea_category_dateafreecategory', (
            ...
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['datea_category.DateaFreeCategory'])),
            ('lft', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('rght', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('tree_id', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('level', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='free_categories_image', null=True, to=orm['datea_image.DateaImage'])),
            ('marker_image', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='free_categories_marker', null=True, to=orm['datea_image.DateaImage'])),
        ))
        db.send_create_signal('datea_category', ['DateaFreeCategory'])


    def backwards(self, orm):
        # Deleting model 'DateaFreeCategory'
        db.delete_table('datea_category_dateafreecategory')
