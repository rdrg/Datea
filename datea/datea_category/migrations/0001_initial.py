...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DateaCategory'
        db.create_table('datea_category_dateacategory', (
            ...
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='category_image', null=True, to=orm['datea_image.DateaImage'])),
            ('marker_image', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='category_marker_image', null=True, to=orm['datea_image.DateaImage'])),
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['datea_category.DateaCategory'])),
            ('lft', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('rght', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('tree_id', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('level', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
        ))
        db.send_create_signal('datea_category', ['DateaCategory'])


    def backwards(self, orm):
        # Deleting model 'DateaCategory'
        db.delete_table('datea_category_dateacategory')
