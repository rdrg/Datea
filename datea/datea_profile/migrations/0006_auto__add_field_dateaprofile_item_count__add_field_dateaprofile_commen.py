...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DateaProfile.item_count'
        db.add_column('datea_profile_dateaprofile', 'item_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'DateaProfile.comment_count'
        db.add_column('datea_profile_dateaprofile', 'comment_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'DateaProfile.vote_count'
        db.add_column('datea_profile_dateaprofile', 'vote_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'DateaProfile.follower_count'
        db.add_column('datea_profile_dateaprofile', 'follower_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'DateaProfile.follow_count'
        db.add_column('datea_profile_dateaprofile', 'follow_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'DateaProfile.item_count'
        db.delete_column('datea_profile_dateaprofile', 'item_count')

        # Deleting field 'DateaProfile.comment_count'
        db.delete_column('datea_profile_dateaprofile', 'comment_count')

        # Deleting field 'DateaProfile.vote_count'
        db.delete_column('datea_profile_dateaprofile', 'vote_count')

        # Deleting field 'DateaProfile.follower_count'
        db.delete_column('datea_profile_dateaprofile', 'follower_count')

        # Deleting field 'DateaProfile.follow_count'
        db.delete_column('datea_profile_dateaprofile', 'follow_count')

        # Removing M2M table for field actions_joined on 'DateaProfile'
        db.delete_table('datea_profile_dateaprofile_actions_joined')
    ...
    models = {
        ...
        'datea_profile.dateaprofile': {
            'Meta': {'object_name': 'DateaProfile'},
            'actions_joined': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'users_joined'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['datea_action.DateaAction']"}),
            'comment_count': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'follow_count': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'profile_image'", 'null': 'True', 'to': "orm['datea_image.DateaImage']"}),
            'image_social': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'profile_image_social'", 'null': 'True', 'to': "orm['datea_image.DateaImage']"}),
            'item_count': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
