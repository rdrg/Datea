...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DateaChannel'
        db.create_table('datea_channel_dateachannel', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='channels', to=orm['auth.User'])),
        ...
        db.send_create_signal('datea_channel', ['DateaChannel'])


    def backwards(self, orm):
        # Deleting model 'DateaChannel'
        db.delete_table('datea_channel_dateachannel')
    ...
    models = {
        ...
        'datea_channel.dateachannel': {
            'Meta': {'object_name': 'DateaChannel'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'channels'", 'to': "orm['auth.User']"})
        },
        'sites.site': {
