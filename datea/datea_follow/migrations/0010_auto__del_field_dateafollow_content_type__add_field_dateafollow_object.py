...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DateaFollow.content_type'
        db.delete_column('datea_follow_dateafollow', 'content_type_id')

        # Adding field 'DateaFollow.object_type'
        db.add_column('datea_follow_dateafollow', 'object_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DateaFollow.content_type'
        db.add_column('datea_follow_dateafollow', 'content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['contenttypes.ContentType']),
                      keep_default=False)

        # Deleting field 'DateaFollow.object_type'
        db.delete_column('datea_follow_dateafollow', 'object_type')
