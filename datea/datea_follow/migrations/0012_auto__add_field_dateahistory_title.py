...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DateaHistory.title'
        db.add_column('datea_follow_dateahistory', 'title',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DateaHistory.title'
        db.delete_column('datea_follow_dateahistory', 'title')
