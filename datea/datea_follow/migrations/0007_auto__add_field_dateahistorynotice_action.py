...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DateaHistoryNotice.action'
        db.add_column('datea_follow_dateahistorynotice', 'action',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='notices', null=True, to=orm['datea_action.DateaAction']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DateaHistoryNotice.action'
        db.delete_column('datea_follow_dateahistorynotice', 'action_id')
