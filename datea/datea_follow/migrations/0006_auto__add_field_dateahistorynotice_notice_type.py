...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DateaHistoryNotice.notice_type'
        db.add_column('datea_follow_dateahistorynotice', 'notice_type',
                      self.gf('django.db.models.fields.CharField')(default='content', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DateaHistoryNotice.notice_type'
        db.delete_column('datea_follow_dateahistorynotice', 'notice_type')
