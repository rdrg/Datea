...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DateaHistory.sender_type'
        db.add_column('datea_follow_dateahistory', 'sender_type',
    ...
    def backwards(self, orm):
        # Deleting field 'DateaHistory.sender_type'
        db.delete_column('datea_follow_dateahistory', 'sender_type')

        # Deleting field 'DateaHistory.receiver_type'
        db.delete_column('datea_follow_dateahistory', 'receiver_type')
