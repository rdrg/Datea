...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DateaNotifySettings.new_reply'
        db.add_column('datea_follow_dateanotifysettings', 'new_reply',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DateaNotifySettings.new_reply'
        db.delete_column('datea_follow_dateanotifysettings', 'new_reply')
