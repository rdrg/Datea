...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DateaHistoryReceiver'
        db.create_table('datea_follow_dateahistoryreceiver', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='receiver_types', null=True, to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('published', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('history_item', self.gf('django.db.models.fields.related.ForeignKey')(related_name='receiver_items', to=orm['datea_follow.DateaHistory'])),
        ))
        db.send_create_signal('datea_follow', ['DateaHistoryReceiver'])

        # Deleting field 'DateaHistory.receiver_id'
        db.delete_column('datea_follow_dateahistory', 'receiver_id')

        # Deleting field 'DateaHistory.url'
        db.delete_column('datea_follow_dateahistory', 'url')

        # Deleting field 'DateaHistory.receiver_type'
        db.delete_column('datea_follow_dateahistory', 'receiver_type_id')


    def backwards(self, orm):
        # Deleting model 'DateaHistoryReceiver'
        db.delete_table('datea_follow_dateahistoryreceiver')

        # Adding field 'DateaHistory.receiver_id'
        db.add_column('datea_follow_dateahistory', 'receiver_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DateaHistory.url'
        db.add_column('datea_follow_dateahistory', 'url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DateaHistory.receiver_type'
        db.add_column('datea_follow_dateahistory', 'receiver_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='receiver_types', null=True, to=orm['contenttypes.ContentType'], blank=True),
                      keep_default=False)
