...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DateaNotifySettings.new_follow'
        db.add_column('datea_follow_dateanotifysettings', 'new_follow',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DateaNotifySettings.new_follow'
        db.delete_column('datea_follow_dateanotifysettings', 'new_follow')
