...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DateaNotifySettings'
        db.create_table('datea_follow_dateanotifysettings', (
            ...
            ('new_content', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('new_comment', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('new_vote', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('notice_from_site', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('notice_from_action', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('datea_follow', ['DateaNotifySettings'])
    ...
    def backwards(self, orm):
        # Deleting model 'DateaNotifySettings'
        db.delete_table('datea_follow_dateanotifysettings')
