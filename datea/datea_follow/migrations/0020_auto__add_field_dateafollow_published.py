...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DateaFollow.published'
        db.add_column('datea_follow_dateafollow', 'published',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DateaFollow.published'
        db.delete_column('datea_follow_dateafollow', 'published')
