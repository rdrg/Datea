...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'DateaHistoryNotice'
        db.delete_table('datea_follow_dateahistorynotice')

        # Adding model 'DateaHistory'
        db.create_table('datea_follow_dateahistory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sent_notices', to=orm['auth.User'])),
            ('published', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('extract', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('notice_type', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('receiver_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='receiver_types', null=True, to=orm['contenttypes.ContentType'])),
            ('receiver_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('acting_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='acting_types', null=True, to=orm['contenttypes.ContentType'])),
            ('acting_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('action', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='notices', null=True, to=orm['datea_action.DateaAction'])),
            ('follow_id', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('history_item_id', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('datea_follow', ['DateaHistory'])


    def backwards(self, orm):
        # Adding model 'DateaHistoryNotice'
        db.create_table('datea_follow_dateahistorynotice', (
            ('follow_id', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('receiver_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('acting_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('notice_type', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ...
            ('extract', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('acting_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='acting_types', null=True, to=orm['contenttypes.ContentType'], blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('history_item_id', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('published', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('action', self.gf('django.db.models.fields.related.ForeignKey')(related_name='notices', null=True, to=orm['datea_action.DateaAction'], blank=True)),
            ('receiver_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='receiver_types', null=True, to=orm['contenttypes.ContentType'], blank=True)),
        ))
        db.send_create_signal('datea_follow', ['DateaHistoryNotice'])

        # Deleting model 'DateaHistory'
        db.delete_table('datea_follow_dateahistory')
