...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DateaHistory.url'
        db.alter_column('datea_follow_dateahistory', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'DateaHistory.url'
        db.alter_column('datea_follow_dateahistory', 'url', self.gf('django.db.models.fields.URLField')(default='', max_length=200))
