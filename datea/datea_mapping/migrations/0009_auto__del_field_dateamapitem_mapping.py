...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DateaMapItem.mapping'
        db.delete_column('datea_mapping_dateamapitem', 'mapping_id')


    def backwards(self, orm):
        # Adding field 'DateaMapItem.mapping'
        db.add_column('datea_mapping_dateamapitem', 'mapping',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='map_items_old', to=orm['datea_mapping.DateaMapping']),
                      keep_default=False)
