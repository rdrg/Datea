...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DateaMapping.image'
        db.delete_column('datea_mapping_dateamapping', 'image_id')


    def backwards(self, orm):
        # Adding field 'DateaMapping.image'
        db.add_column('datea_mapping_dateamapping', 'image',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='mappings', null=True, to=orm['datea_image.DateaImage'], blank=True),
                      keep_default=False)
