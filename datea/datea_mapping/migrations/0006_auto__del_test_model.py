...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing M2M table for field many on 'test_model'
        db.delete_table('datea_mapping_test_model_many')
    ...
    def backwards(self, orm):
        ...
        # Adding M2M table for field many on 'test_model'
        db.create_table('datea_mapping_test_model_many', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('test_model', models.ForeignKey(orm['datea_mapping.test_model'], null=False)),
            ('dateamapitem', models.ForeignKey(orm['datea_mapping.dateamapitem'], null=False))
        ))
        db.create_unique('datea_mapping_test_model_many', ['test_model_id', 'dateamapitem_id'])
