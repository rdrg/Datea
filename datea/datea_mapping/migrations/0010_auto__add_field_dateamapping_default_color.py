...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DateaMapping.default_color'
        db.add_column('datea_mapping_dateamapping', 'default_color',
                      self.gf('django.db.models.fields.CharField')(default='#ff9c00', max_length=7, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DateaMapping.default_color'
        db.delete_column('datea_mapping_dateamapping', 'default_color')
