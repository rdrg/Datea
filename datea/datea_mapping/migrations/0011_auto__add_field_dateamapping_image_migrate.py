...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DateaMapping.image_migrate'
        db.add_column('datea_mapping_dateamapping', 'image_migrate',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='mappings_migrate', null=True, to=orm['datea_image.DateaImage']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DateaMapping.image_migrate'
        db.delete_column('datea_mapping_dateamapping', 'image_migrate_id')
    ...
    models = {
        ...
        'datea_mapping.dateamapitem': {
            ...
            'action': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'map_items'", 'to': "orm['datea_mapping.DateaMapping']"}),
        ...
        'datea_mapping.dateamapitemresponse': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'map_items': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'responses'", 'symmetrical': 'False', 'to': "orm['datea_mapping.DateaMapItem']"}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
        ...
        'datea_mapping.dateamapping': {
            ...
            'default_color': ('django.db.models.fields.CharField', [], {'default': "'#ff9c00'", 'max_length': '7', 'blank': 'True'}),
            ...
            'image_migrate': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'mappings_migrate'", 'null': 'True', 'to': "orm['datea_image.DateaImage']"}),
