...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DateaMapItem.action'
        db.add_column('datea_mapping_dateamapitem', 'action',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='map_items', to=orm['datea_mapping.DateaMapping']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DateaMapItem.action'
        db.delete_column('datea_mapping_dateamapitem', 'action_id')
    ...
    models = {
        ...
        'datea_mapping.dateamapitem': {
            ...
            'mapping': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'map_items_old'", 'to': "orm['datea_mapping.DateaMapping']"}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
