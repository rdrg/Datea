...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FollowedObjectState'
        db.create_table('datea_follow_followedobjectstate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('notice', self.gf('django.db.models.fields.related.ForeignKey')(related_name='followed_object_state', to=orm['notification.Notice'])),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('datea_follow', ['FollowedObjectState'])


    def backwards(self, orm):
        
        # Deleting model 'FollowedObjectState'
        db.delete_table('datea_follow_followedobjectstate')
    ...
    models = {
        ...
        'datea_follow.followedobjectstate': {
            'Meta': {'object_name': 'FollowedObjectState'},
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'notice': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'followed_object_state'", 'to': "orm['notification.Notice']"}),
