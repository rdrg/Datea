...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ReportEnvironment.admin_group'
        db.add_column('datea_report_reportenvironment', 'admin_group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ReportEnvironment.admin_group'
        db.delete_column('datea_report_reportenvironment', 'admin_group_id')
