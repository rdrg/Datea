...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('datea_report_category', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'ReportImage.original_image'
        db.alter_column('datea_report_reportimage', 'original_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))


    def backwards(self, orm):
        
        # Changing field 'Category.image'
        db.alter_column('datea_report_category', 'image', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True))

        # Changing field 'ReportImage.original_image'
        db.alter_column('datea_report_reportimage', 'original_image', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))
