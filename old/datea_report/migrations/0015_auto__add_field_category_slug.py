...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('datea_report_category', 'slug', self.gf('django.db.models.fields.SlugField')(default='slug', max_length=20, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Category.slug'
        db.delete_column('datea_report_category', 'slug')
