...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ReportVote'
        db.create_table('datea_report_reportvote', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('value', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('report', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datea_report.Report'])),
        ))
        db.send_create_signal('datea_report', ['ReportVote'])

        # Adding field 'Report.vote_count'
        db.add_column('datea_report_report', 'vote_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'ReportVote'
        db.delete_table('datea_report_reportvote')

        # Deleting field 'Report.vote_count'
        db.delete_column('datea_report_report', 'vote_count')
