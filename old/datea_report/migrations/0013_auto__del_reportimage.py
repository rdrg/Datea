...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field images on 'Report'
        db.create_table('datea_report_report_images', (
        ...
        db.create_unique('datea_report_report_images', ['report_id', 'dateaimage_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field images on 'Report'
        db.delete_table('datea_report_report_images')
