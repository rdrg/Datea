...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('datea_report_report', 'category_id')

        # Adding M2M table for field category on 'Report'
        db.create_table('datea_report_report_category', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('report', models.ForeignKey(orm['datea_report.report'], null=False)),
            ('category', models.ForeignKey(orm['datea_report.category'], null=False))
        ))
        db.create_unique('datea_report_report_category', ['report_id', 'category_id'])


    def backwards(self, orm):
        
        # Adding field 'Report.category'
        db.add_column('datea_report_report', 'category', self.gf('mptt.fields.TreeForeignKey')(default=None, to=orm['datea_report.Category'], null=True, blank=True), keep_default=False)

        # Removing M2M table for field category on 'Report'
        db.delete_table('datea_report_report_category')
    ...
    models = {
        ...
        'datea_report.report': {
            ...
            'category': ('mptt.fields.TreeManyToManyField', [], {'default': 'None', 'to': "orm['datea_report.Category']", 'null': 'True', 'symmetrical': 'False', 'blank': 'True'}),
