...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('datea_report_category', 'active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Category.active'
        db.delete_column('datea_report_category', 'active')
