...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('datea_report_report', 'content')

        # Adding field 'Report.problem'
        db.add_column('datea_report_report', 'problem', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        # Adding field 'Report.solution'
        db.add_column('datea_report_report', 'solution', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Report.content'
        db.add_column('datea_report_report', 'content', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        # Deleting field 'Report.problem'
        db.delete_column('datea_report_report', 'problem')

        # Deleting field 'Report.solution'
        db.delete_column('datea_report_report', 'solution')
