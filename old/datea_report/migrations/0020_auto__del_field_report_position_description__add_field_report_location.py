...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Report.location_description'
        db.add_column('datea_report_report', 'location_description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Report.location_description'
        db.delete_column('datea_report_report', 'location_description')
