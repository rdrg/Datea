...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Report.position'
        db.alter_column('datea_report_report', 'position', self.gf('django.contrib.gis.db.models.fields.PointField')(null=True, spatial_index=False))


    def backwards(self, orm):
        
        # Changing field 'Report.position'
        db.alter_column('datea_report_report', 'position', self.gf('geoposition.fields.GeopositionField')(max_length=42))
