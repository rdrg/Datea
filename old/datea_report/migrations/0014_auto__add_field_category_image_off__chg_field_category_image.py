...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Category.image_off'
        db.add_column('datea_report_category', 'image_off', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Category.image_off'
        db.delete_column('datea_report_category', 'image_off')
