...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Report.position_description'
        db.add_column('datea_report_report', 'position_description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Changing field 'Report.street'
        db.alter_column('datea_report_report', 'street', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # Deleting field 'Report.position_description'
        db.delete_column('datea_report_report', 'position_description')

        # Changing field 'Report.street'
        db.alter_column('datea_report_report', 'street', self.gf('django.db.models.fields.CharField')(default='', max_length=100))
    ...
    models = {
        ...
        'datea_report.report': {
            ...
            'position_description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
