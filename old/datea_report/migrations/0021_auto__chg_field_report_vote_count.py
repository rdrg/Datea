...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Report.vote_count'
        db.alter_column('datea_report_report', 'vote_count', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Report.vote_count'
        db.alter_column('datea_report_report', 'vote_count', self.gf('django.db.models.fields.IntegerField')())
