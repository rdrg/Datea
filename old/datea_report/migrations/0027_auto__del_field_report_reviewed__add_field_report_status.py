...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Report.reviewed'
        db.delete_column('datea_report_report', 'reviewed')

        # Adding field 'Report.status'
        db.add_column('datea_report_report', 'status', self.gf('django.db.models.fields.CharField')(default='new', max_length=15), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Report.reviewed'
        db.add_column('datea_report_report', 'reviewed', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Report.status'
        db.delete_column('datea_report_report', 'status')
