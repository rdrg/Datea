...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field categories on 'ReportEnvironment'
        db.create_table('datea_report_reportenvironment_categories', (
        ...
        db.create_unique('datea_report_reportenvironment_categories', ['reportenvironment_id', 'category_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field categories on 'ReportEnvironment'
        db.delete_table('datea_report_reportenvironment_categories')
    ...
    models = {
        ...
        'datea_report.reportenvironment': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'default': 'None', 'to': "orm['datea_report.Category']", 'null': 'True', 'symmetrical': 'False', 'blank': 'True'}),
