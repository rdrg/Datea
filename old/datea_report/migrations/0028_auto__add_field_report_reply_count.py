...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Report.reply_count'
        db.add_column('datea_report_report', 'reply_count', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Report.reply_count'
        db.delete_column('datea_report_report', 'reply_count')
