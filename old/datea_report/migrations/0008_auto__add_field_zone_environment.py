...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Zone.environment'
        db.add_column('datea_report_zone', 'environment', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='zones', null=True, blank=True, to=orm['datea_report.ReportEnvironment']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Zone.environment'
        db.delete_column('datea_report_zone', 'environment_id')
