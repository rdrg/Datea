...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ReportEnvironment.welcome_message'
        db.add_column('datea_report_reportenvironment', 'welcome_message', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'ReportEnvironment.report_success_message'
        db.add_column('datea_report_reportenvironment', 'report_success_message', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Changing field 'ReportEnvironment.description'
        db.alter_column('datea_report_reportenvironment', 'description', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # Deleting field 'ReportEnvironment.welcome_message'
        db.delete_column('datea_report_reportenvironment', 'welcome_message')

        # Deleting field 'ReportEnvironment.report_success_message'
        db.delete_column('datea_report_reportenvironment', 'report_success_message')

        # Changing field 'ReportEnvironment.description'
        db.alter_column('datea_report_reportenvironment', 'description', self.gf('django.db.models.fields.TextField')(default=''))
